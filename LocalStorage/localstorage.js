...
//* window.LocalStorage should be avoided because it is synchronous and will block the main thread.
//* It is limited to about 5MB and can contain only strings. window.LocalStorage is not accessible from web workers or service workers.
